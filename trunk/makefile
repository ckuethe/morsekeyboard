...
#
# make flip = Download the hex file to the device, using Atmel's FLIP.
#
# make dfu = Download the hex file to the device on Linux using DFU-Programmer.
#
...
# MyUSB board drivers). If USER is selected, put custom board drivers in a directory called 
...
TARGET = AVRopendousMorseKeyboard
